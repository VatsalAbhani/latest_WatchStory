...
// // --- NEW LINKING LOGIC ---
//   // 1. Determine the destination and method
//   const isExternal = !!post.externalUrl;
//   const destinationUrl = isExternal ? post.externalUrl : `/blog/${post.slug}`;

//   // 2. Define the Wrapper component dynamically
//   // We use Link as the default, but if externalUrl exists, we use a custom Anchor component
//   // to correctly handle the 'href' and 'target="_blank"' properties.
//   const Anchor = ({ children, ...props }: React.AnchorHTMLAttributes<HTMLAnchorElement> & { children: React.ReactNode }) => <a {...props}>{children}</a>;
//   const Wrapper = isExternal ? Anchor : Link;
//   // -------------------------
