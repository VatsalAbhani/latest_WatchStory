...
<section className="relative overflow-hidden py-16 bg-gray-100">
  ...
  <div className="absolute top-0 left-0 right-0 z-30 p-4 md:p-12 md:text-left">
        ...
        <h2 className="font-title font-normal text-3xl md:text-5xl text-offwhite mb-4">
      <TypewriterHeading
        ...
        className="font-title font-normal text-3xl md:text-5xl text-offwhite mb-4"
      />
      </h2>
    ...
    <section className="relative overflow-hidden py-8 bg-gray-100 mt-24 md:mt-32">
      ...
      >
        {brands.map((brand) => (
          <div
            key={brand.id}
            className="flex-shrink-0 w-16 h-18 md:w-24 md:h-26 opacity-50 grayscale hover:opacity-100 hover:grayscale-0 transition-all duration-300"
          >
            <img
              src={brand.logoUrl}
              alt={brand.name}
